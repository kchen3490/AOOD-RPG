//Minigame#2, Front-end class by Kai C.
...
public class RunecastScreen extends RPGPanel implements ActionListener {
    private JPanel helpPanel;
    private Runecast runeGame;
    private JLabel currencyLabel;
    private JLabel statusLabel;
    private JButton[][] space;

    RunecastScreen(int id, RPG game, double xScale, double yScale){
        super(id, game, xScale, yScale);

        runeGame = new Runecast();
        setLayout(null);
        ...
        JLabel titleLabel = new JLabel("Runecast");
        titleLabel.setFont(new Font("Arial",Font.BOLD,(int)(yScale*80)));
        titleLabel.setForeground(Color.BLUE);
        titleLabel.setBounds((int)(xScale*735),(int)(yScale*50),(int)(xScale*450),(int)(yScale*90));
        ...
        ImageIcon help = new ImageIcon(new ImageIcon(fileLocation+"RunecastHelp.png").getImage()
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if(eventName.contains("space")) {
            ...
            runeGame.updateGrid(row,col);
            updateGraphic();

            if(checkWin()) {
                game.updateCurrency(40);
